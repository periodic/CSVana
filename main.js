...
var _user$project$Base$get = function (_p7) {
	var _p8 = _p7;
	return _p8._0.get;
};
var _user$project$Base$view = function (_p9) {
	var _p10 = _p9;
	return _p10._0.view;
};
var _user$project$Base$viewWith = function (f) {
	return function (_p11) {
		return A2(
			_elm_lang$html$Html_App$map,
			f,
			_user$project$Base$view(_p11));
	};
};
var _user$project$Base$subscriptions = function (_p12) {
	var _p13 = _p12;
	return _p13._0.subscriptions;
};
var _user$project$Base$subscriptionsWith = function (f) {
	return function (_p14) {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			f,
			_user$project$Base$subscriptions(_p14));
	};
};
var _user$project$Base$update = F2(
	function (msg, _p15) {
		var _p16 = _p15;
		return _p16._0.update(msg);
	});
	...
	function (f, msg) {
		return function (_p17) {
			return A2(
				...
				f,
				A2(_user$project$Base$update, msg, _p17));
		};
	});
var _user$project$Base$asRoot = function (_p18) {
	var _p19 = _p18;
	return {
		init: {ctor: '_Tuple2', _0: _p19._0, _1: _p19._1},
...
var _user$project$Asana_Api$typeaheadQueryFields = function (resourceType) {
	...
	switch (_p0.ctor) {
		...
		case 'TypeaheadUser':
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'opt_fields', _1: 'name,email,photo'}
				]);
		case 'TypeaheadTag':
			return _elm_lang$core$Native_List.fromArray(
				[]);
...
var _user$project$Asana_Api$apiGetRequest = F4(
	function (path, query, decoder, token) {
		...
		var url = A2(
			...
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Asana_Api$apiRoot, path),
			query);
...
var _user$project$Asana_Api$user = function (user) {
	...
	switch (_p2.ctor) {
		...
		case 'Id':
			return A3(
				_user$project$Asana_Api$apiGetRequest,
				A2(_elm_lang$core$Basics_ops['++'], '/users/', _p2._0),
				_elm_lang$core$Native_List.fromArray(
					[]),
				_user$project$Asana_Decoder$userDecoder);
		default:
				...
				if (_p1.ctor === 'Just') {
					...
					return _elm_lang$core$Result$Err(
						A2(
							...
							A2(_elm_lang$core$Basics_ops['++'], value, '\' into user.')));
				}
			case 'Completion':
				...
				switch (_p5.ctor) {
					...
					case 'CustomNumberFieldInfo':
						...
						if (_p6.ctor === 'Ok') {
							var newField = {
								ctor: '_Tuple2',
								_0: _p5._0,
								_1: _user$project$Asana_Model$NumberValue(_p6._0)
							};
							var customFields = A2(_elm_lang$core$List_ops['::'], newField, task.customFields);
							return _elm_lang$core$Result$Ok(
								_elm_lang$core$Native_Utils.update(
					...
					default:
						var matchingOptions = A2(
							...
							_p5._2);
						var _p8 = _elm_lang$core$List$head(matchingOptions);
						if (_p8.ctor === 'Just') {
							return _elm_lang$core$Result$Ok(
								_elm_lang$core$Native_Utils.update(
									task,
									{
										customFields: A2(
											_elm_lang$core$List_ops['::'],
											{
												ctor: '_Tuple2',
												_0: _p5._0,
												_1: _user$project$Asana_Model$EnumValue(_p8._0)
											},
											task.customFields)
									}));
						} else {
...
var _user$project$Asana_Target$emptyTask = function (projectId) {
	return {
		...
		projects: _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_List.fromArray(
				[projectId])),
		customFields: _elm_lang$core$Native_List.fromArray(
			[])
	};
};
var _user$project$Asana_Target$CustomField = function (a) {
...
var _user$project$CommonViews$iconStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '16px'},
			{ctor: '_Tuple2', _0: 'height', _1: '16px'}
		]));
var _user$project$CommonViews$closeIcon = A2(
	_elm_lang$svg$Svg$svg,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$svg$Svg_Attributes$class('icon closeIcon'),
			_elm_lang$svg$Svg_Attributes$viewBox('0 0 32 32'),
			_user$project$CommonViews$iconStyle
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$points('24.485,27.314 27.314,24.485 18.828,16 27.314,7.515 24.485,4.686 16,13.172 7.515,4.686 4.686,7.515 13.172,16 4.686,24.485 7.515,27.314 16,18.828 ')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
var _user$project$CommonViews$gearIcon = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$svg$Svg_Attributes$class('icon gearIcon'),
			_elm_lang$svg$Svg_Attributes$viewBox('0 0 512 512'),
			_user$project$CommonViews$iconStyle
		]),
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$CommonViews$closeButton = function (msg) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('closeButton'),
...
var _user$project$CommonViews$configButton = function (msg) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('openButton'),
				_elm_lang$html$Html_Events$onClick(msg)
			]),
		_elm_lang$core$Native_List.fromArray(
			[_user$project$CommonViews$gearIcon]));
};
var _user$project$CommonViews$popup = F3(
	function (title, closeMsg, inner) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('Popup')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('Popup-positioner')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('Popup-background')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('Popup-container')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('Popup-dialog')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$CommonViews$closeButton(closeMsg),
											A2(
											_elm_lang$html$Html$div,
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('Popup-title')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('Popup-contents')
												]),
											_elm_lang$core$Native_List.fromArray(
												[inner]))
										]))
...
var _user$project$Components_Csv$headers = function (_p0) {
	return A2(
		_elm_lang$core$Maybe$map,
		function (_) {
			return _.headers;
...
var _user$project$Components_Csv$records = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.csvData;
	if (_p3.ctor === 'Just') {
		var _p4 = _p3._0;
		return _p2.hasHeaderRow ? _elm_lang$core$Maybe$Just(_p4.records) : ((_elm_lang$core$List$isEmpty(_p4.records) && _elm_lang$core$List$isEmpty(_p4.headers)) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
			A2(_elm_lang$core$List_ops['::'], _p4.headers, _p4.records)));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Components_Csv$get = F2(
	function (_p5, model) {
		return A3(
			...
			_user$project$Components_Csv$headers(model),
			_user$project$Components_Csv$records(model));
	});
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							csvData: _elm_lang$core$Maybe$Just(
								_lovasoa$elm_csv$Csv$parse(_p7._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewFiles':
				var _p8 = _elm_lang$core$List$head(_p7._0);
				if (_p8.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$FileReader_FileReader$readFile(_p8._0)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Components_Csv$init = function (_p9) {
	var model = {csvData: _elm_lang$core$Maybe$Nothing, hasHeaderRow: true};
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Components_Csv$numFields = _elm_lang$core$Maybe$map(
	function (_p10) {
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_user$project$FileReader_FileReader$onFileInput(_user$project$Components_Csv$NewFiles)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
...
var _user$project$Components_Csv$create = function (props) {
	return _user$project$Base$create(
		{
			...
			get: _user$project$Components_Csv$get(props)
		});
};
...
var _user$project$Components_Configs_UserInfo$view = function (_p0) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('UserInfo')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				function () {
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('UserInfo-name')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		case 'Loaded':
			...
			return A2(
				...
				(_elm_lang$core$Native_Utils.cmp(
					...
					_p5) : _elm_lang$core$Native_List.fromArray(
					[_user$project$Components_Typeahead$renderNoResultsOption]));
		case 'Loading':
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Components_Typeahead$renderLoadingOption]));
		default:
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Components_Typeahead$view = F2(
	function (_p6, model) {
		var inputElem = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[]));
		var elems = _user$project$Components_Typeahead$isActive(model) ? _elm_lang$core$Native_List.fromArray(
			[
				inputElem,
				_user$project$Components_Typeahead$renderOptions(model)
			]) : _elm_lang$core$Native_List.fromArray(
			[inputElem]);
		return A2(
			_elm_lang$html$Html$div,
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selected: _elm_lang$core$Maybe$Just(
								A2(_elm_lang$core$Debug$log, 'Selection', _p12)),
							fragment: _p12.name,
			...
			case 'InputFocus':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							inputFocused: A2(_elm_lang$core$Debug$log, 'Focused', _p10._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							optionsHovered: A2(_elm_lang$core$Debug$log, 'Hovered', _p10._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Components_Configs_UserConfig$view = F2(
	function (props, model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('UserConfig')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
					...
					if (_p2.ctor === 'Unselected') {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('UserConfig--unselected')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Base$viewWith, _user$project$Components_Configs_UserConfig$TypeaheadMsg, _p2._0)
								]));
					} else {
						return A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('UserConfig--selected')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_user$project$Base$view(_p2._1),
									A2(
									_elm_lang$html$Html$a,
									_elm_lang$core$Native_List.fromArray(
										[
	...
	function (props, msg, model) {
		...
		if (_p8.ctor === 'Selection') {
			...
			if (_p9.ctor === 'Unselected') {
				...
				var ta$ = _p10._0;
				var taCmd = _p10._1;
				var _p11 = _user$project$Base$get(ta$);
				if (_p11.ctor === 'Just') {
					return _user$project$Components_Configs_UserConfig$makeModel(
						_elm_lang$core$Native_Utils.update(
							props,
					...
					return {
						ctor: '_Tuple2',
						_0: _user$project$Components_Configs_UserConfig$Unselected(ta$),
						_1: taCmd
					};
				}
			} else {
...
var _user$project$Components_TargetSelector$targetStrings = function (customFields) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_List.fromArray(
			['', 'Name', 'Description', 'Completion', 'Assignee', 'Due Date', 'Due Date With Time']),
...
var _user$project$Components_TargetSelector$withUnselect = function (inner) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('TargetSelector-unselect')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				inner,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('TargetSelector-unselectButton'),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Components_TargetSelector$Selection(''))
					]),
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Components_TargetSelector$viewSimpleTarget = function (name) {
	return _user$project$Components_TargetSelector$withUnselect(
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('TargetSelector-selectedField TargetSelector-simpleField')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('TargetSelector-targetName')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(name)
	...
	function (name, config) {
		return _user$project$Components_TargetSelector$withUnselect(
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('TargetSelector-selectedField TargetSelector-configField')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
		...
		switch (_p4.ctor) {
			...
			case 'Assignee':
				return A2(
					...
					'Assignee',
					A2(_user$project$Base$viewWith, _user$project$Components_TargetSelector$AssigneeMsg, _p4._0));
			case 'Completion':
				return A2(
					_user$project$Components_TargetSelector$viewWithConfig,
					'Completion',
...
var _user$project$Components_TargetSelector$assigneeComponent = function (_p5) {
	var _p6 = _p5;
	var userConfig = function (mValue) {
		return _user$project$Components_Configs_UserConfig$create(
			{selectedUser: mValue, apiContext: _p6.apiContext});
	};
	var alwaysNothing = _elm_lang$core$Basics$always(_elm_lang$core$Maybe$Nothing);
	var _p7 = _user$project$Components_TargetConfig$create(
		{
...
var _user$project$Components_TargetSelector$updateModel = F3(
	function (props, str, model) {
		var _p8 = props;
		var records = _p8.records;
		var customFields = _p8.customFields;
		var _p9 = str;
		switch (_p9) {
			case 'Name':
			...
			default:
				var _p10 = A2(_user$project$Components_TargetSelector$matchCustomFieldName, _p9, customFields);
				if ((_p10.ctor === 'Just') && (_p10._0.ctor === 'CustomEnumFieldInfo')) {
					var _p12 = _p10._0._2;
					return A3(
						_user$project$Base$pairMap,
						A3(_user$project$Components_TargetSelector$CustomEnumField, _p10._0._0, _p10._0._1, _p12),
						...
						_user$project$Components_TargetConfig$create(
							{
								...
								dataView: function (value) {
									return _user$project$Components_Configs_EnumConfig$create(
										{selectedId: value, enumOptions: _p12});
								},
								records: records
							}));
				} else {
					return A3(
						...
						A2(
							...
							A2(_elm_lang$core$Maybe$map, _user$project$Components_TargetSelector$CustomField, _p10)));
				}
		}
	});
var _user$project$Components_TargetSelector$update = F3(
	function (props, msg, model) {
		var _p13 = {ctor: '_Tuple2', _0: msg, _1: model};
		_v6_3:
		do {
			if (_p13.ctor === '_Tuple2') {
				switch (_p13._0.ctor) {
					case 'Selection':
						return A3(_user$project$Components_TargetSelector$updateModel, props, _p13._0._0, model);
					case 'AssigneeMsg':
						if (_p13._1.ctor === 'Assignee') {
							return A2(
								_user$project$Base$mapFst,
								_user$project$Components_TargetSelector$Assignee,
								A3(_user$project$Base$updateWith, _user$project$Components_TargetSelector$AssigneeMsg, _p13._0._0, _p13._1._0));
						} else {
							break _v6_3;
						}
					case 'CompletionMsg':
						if (_p13._1.ctor === 'Completion') {
							return A2(
								_user$project$Base$mapFst,
								_user$project$Components_TargetSelector$Completion,
								A3(_user$project$Base$updateWith, _user$project$Components_TargetSelector$CompletionMsg, _p13._0._0, _p13._1._0));
						} else {
							break _v6_3;
						}
					default:
...
var _user$project$Components_FieldRow$view = F2(
	function (props, inst) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('FieldRow Grid')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('FieldRow-csv Cell -5of12')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('FieldRow-selector Cell -5of12')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _user$project$Components_Uploader$get = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		return {
			totalRecords: _elm_lang$core$List$length(_p2.records),
			recordsProcessed: _p3.recordsProcessed,
			errors: _p3.errors
		};
	});
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p4._0.row),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', Col ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p4._0.col),
									A2(_elm_lang$core$Basics_ops['++'], ': ', _p4._0.msg))))))
				]));
	} else {
		return A2(
			_elm_lang$html$Html$div,
...
var _user$project$Components_Uploader$Data = F3(
	function (a, b, c) {
...
var _user$project$Components_Uploader$create = function (props) {
	return _user$project$Base$create(
		{
			...
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			get: _user$project$Components_Uploader$get(props)
		});
};
	...
	function (_p5, selected) {
		...
		var options = A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
			A2(_elm_lang$core$List$map, _user$project$Components_WorkspaceSelector$workspaceOption, _p6.workspaces));
		var attrs = _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('WorkspaceSelector'),
				A2(_elm_lang$html$Html_Events$on, 'change', _user$project$Components_WorkspaceSelector$onChange)
			]);
...
var _user$project$Components_Form$get = function (_p0) {
	var _p1 = _p0;
	...
	return A2(
		...
		function (workspace) {
			return A2(
				...
				A2(_elm_lang$core$Maybe$andThen, _p1.projectTypeahead, _user$project$Base$get));
		});
};
var _user$project$Components_Form$Props = F2(
	function (a, b) {
		return {token: a, user: b};
	});
var _user$project$Components_Form$Model = F2(
	function (a, b) {
		return {workspaceSelector: a, projectTypeahead: b};
	});
var _user$project$Components_Form$ProjectTypeaheadMsg = function (a) {
	return {ctor: 'ProjectTypeaheadMsg', _0: a};
};
var _user$project$Components_Form$updateProject = F3(
	function (_p3, msg, model) {
		var _p4 = _p3;
		var _p5 = model.projectTypeahead;
		if (_p5.ctor === 'Just') {
			var _p6 = A3(_user$project$Base$updateWith, _user$project$Components_Form$ProjectTypeaheadMsg, msg, _p5._0);
...
var _user$project$Components_Form$WorkspaceSelectorMsg = function (a) {
	return {ctor: 'WorkspaceSelectorMsg', _0: a};
};
var _user$project$Components_Form$init = function (_p7) {
	var _p8 = _p7;
	...
	var cmd = _elm_lang$core$Platform_Cmd$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Platform_Cmd$map, _user$project$Components_Form$WorkspaceSelectorMsg, wsscmd)
			]));
	return {ctor: '_Tuple2', _0: model, _1: cmd};
};
var _user$project$Components_Form$updateWorkspace = F3(
	function (_p10, msg, model) {
		var _p11 = _p10;
		var _p12 = A3(_user$project$Base$updateWith, _user$project$Components_Form$WorkspaceSelectorMsg, msg, model.workspaceSelector);
		var wss$ = _p12._0;
		var wsscmd = _p12._1;
		var _p13 = function () {
			var _p14 = _user$project$Base$get(wss$);
			if (_p14.ctor === 'Just') {
				return A2(
					_user$project$Base$mapFst,
					_elm_lang$core$Maybe$Just,
					A2(
						_user$project$Base$mapCmd,
						_user$project$Components_Form$ProjectTypeaheadMsg,
						_user$project$Components_Typeahead$create(
							{
...
var _user$project$Components_Form$update = F3(
	function (props, msg, model) {
		...
		if (_p15.ctor === 'WorkspaceSelectorMsg') {
			return A3(_user$project$Components_Form$updateWorkspace, props, _p15._0, model);
		} else {
			return A3(_user$project$Components_Form$updateProject, props, _p15._0, model);
		}
	});
var _user$project$Components_Form$view = F2(
	function (_p16, model) {
		var projects = function () {
			...
			if (_p17.ctor === 'Just') {
				return A2(_user$project$Base$viewWith, _user$project$Components_Form$ProjectTypeaheadMsg, _p17._0);
			} else {
				return A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
		...
		var workspaces = A2(_user$project$Base$viewWith, _user$project$Components_Form$WorkspaceSelectorMsg, model.workspaceSelector);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	return _user$project$Base$create(
		{
			...
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
			get: _user$project$Components_Form$get
		});
};
...
var _user$project$Components_Asana$updateMatcher = F2(
	function (_p1, _p0) {
		...
		var _p4 = {
			...
			_0: A2(
				_elm_lang$core$Maybe$andThen,
				_user$project$Base$get(_p8.form),
				_elm_lang$core$Basics$identity),
			_1: _user$project$Base$get(_p8.csv)
		};
		if (((((_p4.ctor === '_Tuple2') && (_p4._0.ctor === 'Just')) && (_p4._0._0.ctor === '_Tuple2')) && (_p4._1.ctor === 'Just')) && (_p4._1._0.ctor === '_Tuple2')) {
			var _p7 = _p4._1._0._0;
			var _p5 = A2(
				_user$project$Base$mapCmd,
										...
										return _user$project$Components_FieldMatcher$create(
											{
												...
												csvHeaders: _p7,
												csvRecords: _p4._1._0._1,
												customFields: customFieldInfos,
												apiContext: {token: _p9, workspaceId: _p4._0._0._0}
											});
									},
									fetches: A2(
										_elm_lang$core$List$map,
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_App$map,
						_user$project$Components_Asana$FieldMatcherMsg,
						_user$project$Base$view(_p12._0))
					]));
		} else {
			return A2(
				_elm_lang$html$Html$div,
...
var _user$project$Components_Asana$subscriptions = F2(
	function (_p19, _p18) {
		...
		var csvSubs = A2(
			_elm_lang$core$Platform_Sub$map,
			_user$project$Components_Asana$CsvMsg,
			_user$project$Base$subscriptions(_p20.csv));
		var formSubs = A2(
			_elm_lang$core$Platform_Sub$map,
			_user$project$Components_Asana$FormMsg,
			_user$project$Base$subscriptions(_p20.form));
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[formSubs, csvSubs]));
	});
var _user$project$Components_Asana$processMessage = F3(
	function (props, msg, model) {
		...
		switch (_p21.ctor) {
			case 'FormMsg':
				var project = _user$project$Base$get(model.form);
				var _p22 = A2(_user$project$Base$update, _p21._0, model.form);
				var form$ = _p22._0;
				var formCmd = _p22._1;
				var model$ = _elm_lang$core$Native_Utils.update(
					model,
			...
			case 'CsvMsg':
				var _p23 = A2(
					...
					_user$project$Base$get(model.csv));
				var headers = _p23._0;
				var _p24 = A3(_user$project$Base$updateWith, _user$project$Components_Asana$CsvMsg, _p21._0, model.csv);
				var csv$ = _p24._0;
				var csvCmd = _p24._1;
				var model$ = _elm_lang$core$Native_Utils.update(
					model,
				...
				var _p25 = A2(
					...
					_user$project$Base$get(csv$));
				var headers$ = _p25._0;
				return (!_elm_lang$core$Native_Utils.eq(headers, headers$)) ? A2(
					_user$project$Components_Asana$updateMatcher,
					props,
					{ctor: '_Tuple2', _0: model$, _1: csvCmd}) : {ctor: '_Tuple2', _0: model$, _1: csvCmd};
			default:
				var _p26 = model.fieldMatcher;
				if (_p26.ctor === 'Just') {
					var _p27 = A2(_user$project$Base$update, _p21._0, _p26._0);
					var matcher$ = _p27._0;
					var matcherCmd = _p27._1;
...
var _user$project$Components_Asana$viewInputs = F2(
	function (props, model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('Asana-inputs Grid')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('Asana-csv Cell -5of12')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$html$Html_App$map,
							_user$project$Components_Asana$CsvMsg,
							_user$project$Base$view(model.csv))
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('Asana-arrow Cell -2of12')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('→')
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('Asana-form Cell -5of12')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$html$Html_App$map,
							_user$project$Components_Asana$FormMsg,
							_user$project$Base$view(model.form))
						]))
				]));
	});
...
var _user$project$Components_Asana$create = function (props) {
	return _user$project$Base$create(
		{
...
var _user$project$Components_OAuthBoundary$updateOAuth = F3(
	function (props, msg, model) {
		...
		var _p11 = _user$project$OAuth_OAuth$getToken(oauth$);
		if (_p11.ctor === 'Just') {
			var _p12 = A2(
				_user$project$Base$mapCmd,
				_user$project$Components_OAuthBoundary$ChildMsg,
...
var _user$project$Main$init = function (location) {
	...
	var oauthProps = {
		...
		child: function (token) {
			return _user$project$Components_Asana$create(
				{token: token});
		}
	};
	return _user$project$Components_OAuthBoundary$create(oauthProps);
};
